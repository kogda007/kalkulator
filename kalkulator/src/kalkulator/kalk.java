...
public class kalk {
	...
	protected void createContents() {
		...
		shell.setText("Mój pierwszy kalkulator w JAVA");
		...
		PlusButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				{
					MessageDialog.openError(shell, "B³¹d", "Nieprawid³owa wartosc w pierwszej liczbie!");
					return; 
				}
				...
				{
						MessageDialog.openError(shell, "B³¹d", "Nieprawid³owa wartosc w drugiej liczbie!");
						return;
					}
		...
		MinusButton.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				{
						MessageDialog.openError(shell, "Blad", "Nieprawid³owa wartosc w drugiej liczbie!");
						return;
					}
				int answer = number1 - number2;
